...
The chirp signals are also clearly visible (more details in the document [Chirp Signal](../Sinarg/Chirp.md)). These chirp signals are used to excite the drone across a wide frequency range, showing how the system responds to different frequencies.
<p align="center">
