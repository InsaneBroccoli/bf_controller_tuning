...
% Decimate the full matrix once (blackbox runs at the FC loop rate; poshold
% debug values update at ~100 Hz via GPS updates, so decimation brings the 
% effective analysis rate to ~100 Hz while keeping a single decimation factor).
