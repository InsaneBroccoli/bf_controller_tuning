function pdfexport_latex(pdfname,pdfsize,fontsize,pdfpath)
...
%
% pdfexport_latex(pdfname,pdfsize,fontsize,pdfpath)
% -------------------------------------------------
%
...
%
%    Bode:          pdfsize = [14 9];  
%    Zeitsignale:   pdfsize = [15 10];
%    Subfigure:     pdfsize = [9.5 8.5];
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for k = 1:length(hchild)
    set(hchild(k),'linewidth',0.5,'fontsize',fontsize - 1,...
        'xcolor',colorVec,'ycolor',colorVec,'zcolor',colorVec);                 
    set(get(hchild(k),'xlabel'),'interpreter','latex',...
        'fontSize',fontsize,'color',colorVec);
    set(get(hchild(k),'ylabel'),'interpreter', 'latex',...
        'fontSize',fontsize,'color',colorVec);
    set(get(hchild(k),'title'),'interpreter', 'latex',...
        'fontSize',fontsize,'color',colorVec);
end
